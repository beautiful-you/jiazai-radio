...
EOT;
    ...
    public function display()
    {
        ...
        $qrcode = "<a href='https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={$this->value}' target='_blank'><img src='https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={$this->value}' style='height: 150px;width: 150px;'/></a>";
